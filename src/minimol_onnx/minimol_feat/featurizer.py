...
from . import nmp
from .tensor import one_of_k_encoding
from .positional_encoding import get_all_positional_encodings
...
def mol_to_adjacency_matrix(
    ...
    # VENDORED CHANGE: modern scipy rejects float16. Numerically inert --
